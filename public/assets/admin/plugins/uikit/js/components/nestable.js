    ...
    UI.component('nestable', {
        ...
        init: function() {
            ...
            this.on('click', '[data-nestable-action]', function(e) {
                ...
                if (action === 'toggle') {
                	if(item.hasClass($this.options.collapsedClass)){
                    	$this.trigger('expand.uk.nestable', item);
                    }else{
                    	$this.trigger('collapse.uk.nestable', item);
                    }
            ...
            var onStartEvent = function(e) {
                ...
                $this.index = li.index();
                $this.parent = li.closest('ul').data('parent') || 0;
        ...
        dragStart: function(e) {
            ...
            this.lastParent = dragItem.parent();
        ...
        dragStop: function(e) {
            ...
            this.dragEl.remove();
            var newParent = $(el[0].parentNode)[0];
            if (this.lastParent[0] != newParent || this.tmpDragOnSiblings[0]!=el[0].previousSibling || this.tmpDragOnSiblings[1]!=el[0].nextSibling || (this.tmpDragOnSiblings[1] && this.tmpDragOnSiblings[1]!=el[0].nextSibling)) {
            ...
            var id = li.data('id');
            var index = li.index();
            var parent = li.closest('.uk-parent').data('id') || 0;
            
            if (this.parent !== parent) {
                this.element.trigger('parent.uk.nestable',[li, id, parent, index]);
            } else {
                this.element.trigger('sort.uk.nestable',[li, id, index-this.index]);
            }
